...
public class Personnel_Get_Data extends BaseTest
{
    @Test(priority = 17, description = "To verify the Get Personnel Data API   ")
    public void Get_Personnel_DownloadTemplate() throws IOException, InterruptedException {
       ...
       Assert.assertEquals(response.getStatusCode(), 200);
        writeRequestAndResponseInReport(Personnel_Get_Data.writer.toString(), response.prettyPrint(), "Get Personnel Data Fetched Successfully!");
    }
}